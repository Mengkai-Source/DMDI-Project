...
L = 10;  % Lead time(settle down regarding the real case )
Cm = 25000; % Maintenance Cost
Cs = 500; % Shipping Cost

% Load Production Schedule Data (pull this prodSchedule from Forcam APIs)
[~,prodSchedule,~]= xlsread('C:\Users\xu.meng\Desktop\Dynamic Scheduler Test Code 20190908\Dynamic Scheduler Test Code 20190908\Data Files\Orders_Scheduled_01.02_MB.xlsx');
...
[Xo, Xm, To, Tm, order_risk,Maintenance_Window]...
